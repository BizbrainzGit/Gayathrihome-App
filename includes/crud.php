...
// define('DOMAIN_URL', 'http://52.66.249.224/Athidi/');
define('DOMAIN_URL', '/Gayathrihome-App/'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
...
class Database
{
    ...
    private $db_pass = "";
    private $db_name = "gayathrihome-app";    // Change as required
